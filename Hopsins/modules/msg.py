...
import os
from Hopsins.config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,UPDATES_CHANNEL, OWNER
class Messages():
      HELP_MSG = [
        ".",
f"""
...
× If Assistant Bot does not join Please Add @{ASSISTANT_NAME} to your group and try again


**» Orders for members in the group can also :**
...
× /userbotjoin - To Invite assistant to your chat obrolan
